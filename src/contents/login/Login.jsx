      ...
      <div className='flex flex-col justify-start items-center gap-y-8'>
          ...
          <div className=' flex justify-between gap-x-7'>
            ...
            <div className=' flex items-center justify-center'>
              <button className=' bg-green-500 w-[80px] h-10 rounded-xl border-solid border-blue-200 font-light text-white hover:bg-blue-500'><Link to='/Principal'>Ingresar</Link></button>
            </div>
          </div>
          </div>
      </div>
