      ...
      <div className='flex flex-col justify-start items-center gap-y-8'>
          ...
          <div className=' bg-gray-700 h-[400px] w-[400px] flex flex-col justify-center items-center bg-opacity-80 rounded-lg shadow-lg shadow-gray-600 gap-y-6'>
            ...
            <form action="" className=' flex flex-col gap-y-2 w-[300px]'>
              ...
              <input type="text" className=' w-full text-center rounded-lg py-1' value={email} onChange={(e) => setEmail(e.target.value)}/>
              <h2 className=' text-center text-white font-serif text-2xl'>Contraseña:</h2>
              <input type="password" className=' w-full text-center rounded-lg py-1' value={password} onChange={(e) => setPassword(e.target.value)}/>
            </form>
          <div className=' flex justify-between gap-x-7'>
            ...
            <div className=' flex items-center justify-center'>
              <button className=' bg-blue-500 w-[80px] h-10 rounded-xl border-solid border-blue-200 font-serif text-black hover:bg-blue-700 ml-6' onClick={login}><Link to='/Principal'>Ingresar</Link></button>
            </div>
          </div>
          </div>
      </div>
